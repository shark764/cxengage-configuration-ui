...
# [0.104.2] - 2021-05-31
### Changed
- CXV1-26901 - Config-UI | Capacity Rules | Cancel/Submit buttons visible when viewing a Published version.
...
# [0.103.0] - 2021-05-26
### Added
- CXV1-24408: Media Form audio file upload functionality

# [0.102.1] - 2021-05-20
### Fixed
- CXV1-26875 - Config-UI | Add Media page to Early Access Feature page.
...
## [0.94.0] - 2020-12-17
### Added
- CXV1-23250 - Config 2 | Add localization to forecast dashboards entity page.
...
## [0.92.3] - 2020-12-04
### Added
- CXV1-23547 - Config 2 | Identity Providers - Unit tests.
...
## [0.92.1] - 2020-11-30
### Added
- CXV1-23375 - Config 2 | Identity Providers - Add localization support.
...
- CXV1-18678 - Config 2 | Identity Providers - Create New.
...
## [0.85.1] - 2020-09-22
### Fixed
- <no-jira> - Fix AgentStateMonitoring saved filters not applying on reload.
...
## [0.83.1] - 2020-07-09
- <no-jira> - Fix to Navbar items not showing submenu when clicking them when language is not English

## [0.83.0] - 2020-09-01
### Added
- CXV1-22950 - Config 2 - Integrations page missing Global Dial Params for Twilio Integration.
...
## [0.81.26] - 2020-08-28
### Fixed
- <no-Jira> - Added Contact Attribute selector unit tests.
...
## [0.81.18] - 2020-08-18
### Fixed
- CXV1-20902 - Agent State Monitoring does not save column filters chosen if you navigate to another page

## [0.81.17] - 2020-08-17
### Fixed
- CXV1-15878 - Change sidepanel view for users with readonly permissions.
...
## [0.81.9] - 2020-08-04
### Added
- CXV1-22901 - Bulk Actions not working for Business Hours V2
...
## [0.81.5] - 2020-07-28
### Added
- CXV1-22869 - New “Tenant Access” column.

## [0.81.4] - 2020-07-27
### Fixed
- CXV1-22868 - Update the “Platform Status” login details values
...
## [0.81.2] - 2020-06-15
### Added
- CXV1-22589 - Business Hours Unit Tests - Full pages
...
## [0.79.12] - 2020-06-10
### Added
- CXV1-22590 - Business Hours Unit Tests - Epics
...
### [0.79.8] - 2020-06-25
### Fixed
- CXV1-22704 - Issues regarding Versions/Draft table for Business Hours V2
...
## [0.78.12] - 2020-06-17
### Fixed
- CXV1-22498 - Flow Management in Config 2 missing version Created By value when user is disabled
...
## [0.78.9] - 2020-06-10
### Fixed
- CXV1-22588 - Business Hours Unit Tests - Selectors
...
## [0.78.6] - 2020-06-10
- CXV1-22620 - Fix end time event of 12AM to be displayed as rest of the day in Calendar component
...
## [0.76.0] - 2020-04-28
## Added
- CXV1-21472 - Basic Page Structure - Edit Draft
...
## [0.75.7] - 2020-05-05
### Fixed
- CXV1-21827 - Agent State Monitoring now shows System Presence Reasons
...
## [0.75.4] - 2020-04-29
### Fixed
- CXV1-22338 - Dispatch Mappings - Can't submit new dispatch mapping if flow dropdown is unfocused while version list is fetching
...
## [0.75.2] - 2020-04-28
### Fixed
- <no-Jira> - Moved timezones in to it's own reducer.
...
## [0.72.22] - 2020-04-14
## Fixed
- CXV1-13378 - Generic Lists - Bulk Actions
...
## [0.72.11] - 2020-03-18
## Fixed
- CXV1-20945 - Presence Reason List Display Not In Order.

## [0.72.10] - 2020-03-10
## Fixed
- CXV1-21837 - Remove initial and default values from Custom Attributes entity page
...
## [0.68.3] - 2019-11-25
## Changed
- <no-jira> - Remove disposition and dispositionsLists from Beta Features.
...
## [0.66.28] - 2019-11-01
## Fixed
- CXV1-20500 - Wrong error message script on bulk actions. Group 'everyone' fails with wrong error message.
...
## [0.66.17] - 2019-10-23
## Changed
- <no-jira> - Version bump components library to 0.55.10.
...
## [0.65.11] - 2019-09-27
### Fixed
- CXV1-19972 - No rows were displayed when list of skills in column filter was empty.
...
### Changed
- Version bump utils library to 1.6.13.
- Version bump component library to 0.41.0.
...
- User tenant permissions are gotten from Config-UI1 instead of Config-UI2.
- Beta pages are no longer showing loading icon forever if localStorage is cleared.
...
- CXV1-15515 - Notifications for bulk actions on Users page are more descriptive.
- CXV1-17476 - Dispatch mappings page is no longer setting a flow and populating versions on creating.
