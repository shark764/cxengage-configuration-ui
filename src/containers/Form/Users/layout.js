    ...
    <form onSubmit={handleSubmit} key={key}>
      <Wrapper>
        ...
        <DetailWrapper open={true}>
          ...
          {userHasNameSet && displayResetPassword && status === 'enabled' && (
            <ConfirmationWrapper
