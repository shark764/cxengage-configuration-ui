      ...
      {!allDependenciesFetched || isSaving ? (
        ...
        <Wrapper>
          ...
          {selectedEntityId !== 'create' && (
            <Fragment>
              <DetailWrapper open data-automation="tenantDetailsSVG">
                <WrappedDetailHeader text="Parent Tenant" />
          ...
          {selectedEntityId !== 'create' && (
            <Fragment>
              <DetailWrapper open data-automation="slaSVG">
                <WrappedDetailHeader text="SLA" />
                <SelectField
                  name="defaultSlaId"
          ...
          <DetailWrapper open data-automation="brandingSVG">
            <WrappedDetailHeader text="Branding" />
            {selectedEntityId !== 'create' && (
              <Fragment>
                <InputField
                  name="productName"
