...
import UpdateTransferListItemsForm, { mapStateToProps } from '../Update';
...
getSelectedTransferListItemValues.mockImplementation(() => 'mockUpdateTransferListItemValues');

describe('TransferLists Renders', () => {
  it('renders', () => {
    const store = createStore(state => state);
    expect(shallow(<UpdateTransferListItemsForm store={store}>Child</UpdateTransferListItemsForm>)).toMatchSnapshot();
  });
});
